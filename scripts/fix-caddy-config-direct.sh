#!/bin/bash
#
# DevSystem - Caddy Konfigurationskorrektur (Direkter Ansatz)
# Autor: DevSystem Team
# Datum: 2026-04-08
#
# Beschreibung: 
# Dieses Skript korrigiert die Caddy-Konfiguration mit einem direkteren Ansatz,
# indem es eine vollständige Konfiguration ohne Snippets erstellt.
...
log_message "Erstelle neue, direkte Caddy-Konfiguration..."
...
log_message "Erstelle neue Caddyfile..."
...
# Metriken-Endpunkt mit Tailscale-Zugriffsbeschränkung
:2019 {
    @tailscale_metrics {
        remote_ip 100.64.0.0/10
    }
    
    metrics @tailscale_metrics
    
    respond @not_tailscale_metrics 403 {
        body "Zugriff nur über Tailscale erlaubt"
    }
    
    @not_tailscale_metrics {
...
log_success "Neue Caddyfile erstellt."
