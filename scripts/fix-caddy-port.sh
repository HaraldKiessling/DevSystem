#!/bin/bash
#
# DevSystem - Caddy Port-Korrektur
# Autor: DevSystem Team
# Datum: 2026-04-08
#
# Beschreibung: 
# Dieses Skript korrigiert die Caddy-Konfiguration, indem es den Caddy-Server 
# auf Port 8443 statt 443 (Standard-HTTPS-Port) laufen lässt, da Port 443 bereits 
# von Tailscale verwendet wird.
...
log_message "Konfiguriere Caddy für Port ${CADDY_HTTPS_PORT} (statt 443)..."

# Prüfe, welcher Prozess Port 443 belegt
log_message "Prüfe, welcher Prozess Port 443 belegt..."
PORT_INFO=$(ss -tulpn | grep :443)
log_message "Port 443 wird aktuell verwendet von: ${PORT_INFO}"
...
# Erstelle die neue Konfiguration für nicht-Standard HTTPS-Port
...
:${CADDY_HTTPS_PORT} {
    ...
    handle {
        respond "DevSystem Caddy Server"
    }
...
log_message ""
log_message "Info: Port 443 wird von Tailscale verwendet, daher läuft Caddy auf Port ${CADDY_HTTPS_PORT}"
log_message ""
log_message "Logs:"
